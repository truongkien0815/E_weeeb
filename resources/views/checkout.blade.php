...
<head>
	...
	<!-- Custom stlylesheet -->
	<link type="text/css" rel="stylesheet" href="{{ asset('css/stylest.css') }}" />
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">                            
          <a class="nav-link active" aria-current="page" href="#">    <i class="fa fa-phone"></i> +021-95-51-84</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#"><i class="fa fa-envelope-o"></i> email@email.com</a></a>
        </li>
		...
		<li class="nav-item">
          <a class="nav-link" href="#"><i class="fa fa-dollar"></i> USD </a>
        </li>
		@if(!isset(Auth::user()->name))
		<li class="nav-item">
		
          <a class="nav-link" href="#"><i class="fa fa-login"></i> My Account</a>
        </li>
		@else
		<li class="nav-item">
		
		<a class="nav-link" href="#"><i class="fa fa-login"></i> {{Auth::user()->name}}</a>
	  </li>
	  @endif
		<li class="nav-item">
          <a class="nav-link" href="#"><i class="fa fa-login"></i> Log In </a>
        </li>
        <li class="nav-item">
...
<div class="form-group">
								<input class="input" value="{{ $item['user_id'] }}" required="required" type="text" name="user_id" readonly placeholder="iduser">
							</div>
							@endforeach
@endif -->
@if(!isset(Auth::user()->name))
									88
										@else
<input class="input" value="{{Auth::user()->id}}" required="required" type="text" name="user_id" readonly placeholder="iduser">
					...
					<div class="col-md-6 order-details">
						...
						<div class="col-sm-2 hidden-xs"><img src="{{ asset('/images/'.$item['image']) }}" style="width: 80px" alt="">
							...
							<div>số lượng</div>
							<div>
							<!-- <input type="number" value="{{ $item['quantity'] }}" placeholder="so luong" max=5 class="form-control"  name="soluong"> -->
									<input type="text" readonly value="{{ $item['quantity'] }}" name="soluong" id="">
								</div>
							</div>
						...
						<!-- <input type="text" value="{{$item['user_id']}}" name="id" id="" readonly> -->
					...
					<div class="col-md-12">
						<div class="newsletter">
							...
							<form action="" method="get">
								...
								@if($cart->items != null)
								<p></p>
								<a href=""><button class="primary-btn send-btn"><i class="fa fa-envelope"></i> SEND ORDERS INVOICE</button></a>
								<br>
								@else
